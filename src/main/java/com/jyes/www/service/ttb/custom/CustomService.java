...
import com.jyes.www.mapper.ttb.CustomMapper;
import com.jyes.www.common.Config;
import com.jyes.www.util.StringUtil;
import com.jyes.www.vo.ttb.MailFormLogVo;
import com.jyes.www.vo.ttb.MailFormSendListVo;

@Service(value = "ttbCustomService")
public class CustomService implements ICustomService {

	@Autowired
	private JavaMailSender mailSender;

	@Resource(name = "ttbCustomMapper")
	...
	public int sendMailForm() throws SQLException {
		...
		// ArrayList<Object> response_mailFormLogVoList =
		// (ArrayList<Object>)customMapper.selectMailFormLogDataWhereRegDate(request_MailFormLogVo);
		// int count = 29;
		// while (count>-1) {
		// System.out.println(count);
		// String request_date = (String)customMapper.selectDayDate(-count);//2019-12-13
		// ArrayList<Object> mailFormLogVoList =
		// (ArrayList<Object>)customMapper.selectMailFromDataList(request_date);
		...
		// 어제부터 30일전 통계 데이터
		ArrayList<Object> response_mailFormLogVoList = (ArrayList<Object>) customMapper
				.selectMailFromToday30DaysBeforeData();
		...
		html += "<tbody>";
		html += "<tr>";
		html += "<th colspan=\"19\" style=\"font-family:Arial, sans-serif;font-size:18px;font-weight:normal;padding:2px 10px;border-left:2px solid black;border-top:2px solid black;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;height:45px;\"> &lt;JSAM "
				+ sdf.format(cal2.getTime()) + " 현황 보고&gt; </th>";
		html += "</tr>";
		html += "<tr>";
		...
		try {
			...
			html += "<th style=\"font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;background-color:#adadad;color:white;\">"
					+ sdf_date_sub.format(sdf_date.parse(StringUtil.nvl(mailFormLogVo.getDate_01()))) + "</th>";
			html += "<th style=\"font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;background-color:#adadad;color:white;border-right: 1px solid black; border-left: 1px solid black;\">"
					+ sdf_date_sub.format(sdf_date.parse(StringUtil.nvl(mailFormLogVo.getDate_02()))) + "</th>";
			html += "<th style=\"font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;background-color:#adadad;color:white;border-right: 1px solid black; border-left: 1px solid black;\">"
					+ sdf_date_sub.format(sdf_date.parse(StringUtil.nvl(mailFormLogVo.getDate_03()))) + "</th>";
			html += "<th style=\"font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;background-color:#adadad;color:white;border-right: 1px solid black; border-left: 1px solid black;\">"
					+ sdf_date_sub.format(sdf_date.parse(StringUtil.nvl(mailFormLogVo.getDate_04()))) + "</th>";
			html += "<th style=\"font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;background-color:#adadad;color:white;border-right: 1px solid black; border-left: 1px solid black;\">"
					+ sdf_date_sub.format(sdf_date.parse(StringUtil.nvl(mailFormLogVo.getDate_05()))) + "</th>";
			html += "<th style=\"font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;background-color:#adadad;color:white;border-right: 1px solid black; border-left: 1px solid black;\">"
					+ sdf_date_sub.format(sdf_date.parse(StringUtil.nvl(mailFormLogVo.getDate_06()))) + "</th>";
			html += "<th style=\"font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;background-color:#adadad;color:white;border-right: 1px solid black; border-left: 1px solid black;\">"
					+ sdf_date_sub.format(sdf_date.parse(StringUtil.nvl(mailFormLogVo.getDate_07()))) + "</th>";
			html += "<th style=\"font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;background-color:#adadad;color:white;border-right: 1px solid black; border-left: 1px solid black;\">"
					+ sdf_date_sub.format(sdf_date.parse(StringUtil.nvl(mailFormLogVo.getDate_08()))) + "</th>";
			html += "<th style=\"font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;background-color:#adadad;color:white;border-right: 1px solid black; border-left: 1px solid black;\">"
					+ sdf_date_sub.format(sdf_date.parse(StringUtil.nvl(mailFormLogVo.getDate_09()))) + "</th>";
			html += "<th style=\"font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;background-color:#adadad;color:white;border-right: 1px solid black; border-left: 1px solid black;\">"
					+ sdf_date_sub.format(sdf_date.parse(StringUtil.nvl(mailFormLogVo.getDate_10()))) + "</th>";
			html += "<th style=\"font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;background-color:#adadad;color:white;border-right: 1px solid black; border-left: 1px solid black;\">"
					+ sdf_date_sub.format(sdf_date.parse(StringUtil.nvl(mailFormLogVo.getDate_11()))) + "</th>";
			html += "<th style=\"font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;background-color:#adadad;color:white;border-right: 1px solid black; border-left: 1px solid black;\">"
					+ sdf_date_sub.format(sdf_date.parse(StringUtil.nvl(mailFormLogVo.getDate_12()))) + "</th>";
			html += "<th style=\"font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;background-color:#adadad;color:white;border-right: 1px solid black; border-left: 1px solid black;\">"
					+ sdf_date_sub.format(sdf_date.parse(StringUtil.nvl(mailFormLogVo.getDate_13()))) + "</th>";
			html += "<th style=\"font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;background-color:#adadad;color:white;border-right: 1px solid black; border-left: 1px solid black;\">"
					+ sdf_date_sub.format(sdf_date.parse(StringUtil.nvl(mailFormLogVo.getDate_14()))) + "</th>";
			html += "<th style=\"font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;background-color:#adadad;color:white;border-left: 1px solid black;\">"
					+ sdf_date_sub.format(sdf_date.parse(StringUtil.nvl(mailFormLogVo.getDate_15()))) + "</th>";
		...
		html += "</tr>";
		html += "<tr>";
		html += "<td style=\"border-color:inherit;text-align:center;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;\" rowspan=\"12\">"
				+ mailFormLogVo.getCategory_1() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:center;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;\" rowspan=\"3\">"
				+ mailFormLogVo.getCategory_2() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:center;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;background-color:#ffecc1;\" colspan=\"2\">"
				+ mailFormLogVo.getName() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;\">"
				+ mailFormLogVo.getCount_01() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_02() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_03() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_04() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_05() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_06() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_07() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_08() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_09() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_10() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_11() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_12() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_13() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_14() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;\">"
				+ mailFormLogVo.getCount_15() + "</td>";
		html += "</tr>";
		...
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-top: 2px solid black;border-bottom: 2px solid black;background-color:#d9e1f2;\">"
				+ mailFormLogVo.getCount_01() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-top: 2px solid black;border-bottom: 2px solid black;background-color:#d9e1f2;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_02() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-top: 2px solid black;border-bottom: 2px solid black;background-color:#d9e1f2;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_03() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-top: 2px solid black;border-bottom: 2px solid black;background-color:#d9e1f2;border-right: 1px solid black; border-left: 1px solid black;\">"
		...
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black; border-bottom:2px solid black;\">"
				+ mailFormLogVo.getCount_01() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:0px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black; border-bottom:2px solid black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_02() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black; border-bottom:2px solid black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_03() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black; border-bottom:2px solid black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ mailFormLogVo.getCount_04() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black; border-bottom:2px solid black;border-right: 1px solid black; border-left: 1px solid black;\">"
		...
		mailFormLogVo = (MailFormLogVo) response_mailFormLogVoList.get(j++);
		html += "<tr>";
		html += "<td style=\"border-color:inherit;text-align:center;font-family:Arial, sans-serif;font-size:14px;padding:2px 5px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;\" rowspan=\"11\">"
				+ mailFormLogVo.getCategory_1() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:center;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;\" rowspan=\"3\">"
				+ mailFormLogVo.getCategory_2() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:center;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;background-color:#fce4d6;\" colspan=\"4\">"
				+ mailFormLogVo.getName() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;\">"
				+ mailFormLogVo.getCount_01() + "</td>";
		html += "</tr>";
		...
		mailFormLogVo = (MailFormLogVo) response_mailFormLogVoList.get(j++);
		html += "<tr>";
		html += "<td style=\"border-color:inherit;text-align:center;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-top: 2px solid black;border-bottom: 2px solid black;background-color:#d6dce4; font-weight: 600;\" colspan=\"4\">"
				+ mailFormLogVo.getName() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-top: 2px solid black;border-bottom: 2px solid black;background-color:#d6dce4;\">"
				+ mailFormLogVo.getCount_01() + "</td>";
		html += "</tr>";
		...
		mailFormLogVo = (MailFormLogVo) response_mailFormLogVoList.get(j++);
		html += "<tr>";
		html += "<td style=\"border-color:inherit;text-align:center;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;\" rowspan=\"8\">"
				+ mailFormLogVo.getCategory_2() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:center;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;background-color:#fff;\" colspan=\"2\" rowspan=\"4\">"
				+ mailFormLogVo.getCategory_3() + "</td>";
		html += "</tr>";
		html += "<tr>";
		html += "<td style=\"border-color:inherit;text-align:center;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;background-color:#f4b084;\" colspan=\"2\">"
				+ mailFormLogVo.getName() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;\">"
				+ mailFormLogVo.getCount_01() + "</td>";
		html += "</tr>";
		...
		html += "<td style=\"border-color:inherit;text-align:center;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;background-color:#f4b084;\" colspan=\"2\">"
				+ mailFormLogVo.getName() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black; color:red;\">"
				+ mailFormLogVo.getCount_01() + "</td>";
		html += "</tr>";
		...
		mailFormLogVo = (MailFormLogVo) response_mailFormLogVoList.get(j++);
		html += "<tr>";
		html += "<td style=\"border-color:inherit;text-align:center;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;background-color:#fff; border-bottom: 2px solid black\" colspan=\"2\" rowspan=\"4\">"
				+ mailFormLogVo.getCategory_3() + "</td>";
		html += "</tr>";
		html += "<tr>";
		html += "<td style=\"border-color:inherit;text-align:center;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;background-color:#f4b084;\" colspan=\"2\">"
		...
		mailFormLogVo = (MailFormLogVo) response_mailFormLogVoList.get(j++);
		html += "<tr>";
		html += "<td style=\"border-color:inherit;text-align:center;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;background-color:#f4b084; border-bottom: 2px solid black\" colspan=\"2\">"
				+ mailFormLogVo.getName() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black; color:red; border-bottom: 2px solid black\">"
				+ mailFormLogVo.getCount_01() + "</td>";
		html += "</tr>";
		html += "</tbody>";
		html += "</table>";
		...
		html += "<tbody>";
		html += "<tr>";
		html += "<th colspan=\"19\" style=\"font-family:Arial, sans-serif;font-size:18px;font-weight:normal;padding:2px 10px;border-left:2px solid black;border-top:2px solid black;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;height:45px;\"> &lt;이벤트 이용권 "
				+ sdf.format(cal2.getTime()) + " 현황 보고&gt; </th>";
		html += "</tr>";
		html += "<tr>";
		html += "<th style=\"font-family:Arial, sans-serif;font-size:14px;font-weight:normal;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;background-color:#adadad;color:white;\">대분류</th>";
		...
		html += "</tr>";
		html += "<tr>";
		html += "<td style=\"border-color:inherit;text-align:center;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;\" rowspan=\"2\">"
				+ mailFormLogVo.getCategory_1() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:center;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:2px;overflow:hidden;word-break:normal;border-color:black;\" rowspan=\"2\">"
				+ mailFormLogVo.getCategory_2() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:center;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;background-color:#ffecc1;\" colspan=\"2\">"
				+ mailFormLogVo.getName() + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;\">"
				+ checkNullAndEmpty(mailFormLogVo.getCount_01()) + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ checkNullAndEmpty(mailFormLogVo.getCount_02()) + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ checkNullAndEmpty(mailFormLogVo.getCount_03()) + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ checkNullAndEmpty(mailFormLogVo.getCount_04()) + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ checkNullAndEmpty(mailFormLogVo.getCount_05()) + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ checkNullAndEmpty(mailFormLogVo.getCount_06()) + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ checkNullAndEmpty(mailFormLogVo.getCount_07()) + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ checkNullAndEmpty(mailFormLogVo.getCount_08()) + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ checkNullAndEmpty(mailFormLogVo.getCount_09()) + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ checkNullAndEmpty(mailFormLogVo.getCount_10()) + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ checkNullAndEmpty(mailFormLogVo.getCount_11()) + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ checkNullAndEmpty(mailFormLogVo.getCount_12()) + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ checkNullAndEmpty(mailFormLogVo.getCount_13()) + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;border-right: 1px solid black; border-left: 1px solid black;\">"
				+ checkNullAndEmpty(mailFormLogVo.getCount_14()) + "</td>";
		html += "<td style=\"border-color:inherit;text-align:right;font-family:Arial, sans-serif;font-size:14px;padding:2px 10px;border-style:solid;border-width:1px;border-right:2px solid black;overflow:hidden;word-break:normal;border-color:black;\">"
				+ checkNullAndEmpty(mailFormLogVo.getCount_15()) + "</td>";
		html += "</tr>";
