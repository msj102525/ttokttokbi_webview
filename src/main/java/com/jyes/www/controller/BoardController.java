...
public class BoardController {
	...
	public String call(HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		try {
			...
			e.printStackTrace();
			logData.append("["+LogUtils.getCurrentTime()+"]"+" "+"query error getContentsSuggestedCharactersList : "+e.toString()+"\n");
		}
		logData.append("["+LogUtils.getCurrentTime()+"]"+" "+"query end getContentsSuggestedCharactersList ArrayList<BoardCategoryVo> al_tbBoardFaqCategoryList : "+al_tbBoardFaqCategoryList+"\n");
		if(al_tbBoardFaqCategoryList!=null) {
			...
			try {
				logData.append("["+LogUtils.getCurrentTime()+"]"+" "+"query start getBoardFaqCategoryContentsList String code:"+code+"\n");
				al_tbBoardFaqCategoryContentsList = (ArrayList<BoardFaqVo>)boardService.getBoardFaqCategoryContentsList(code);
			} catch(Exception e) {
				e.printStackTrace();
				logData.append("["+LogUtils.getCurrentTime()+"]"+" "+"query error getBoardFaqCategoryContentsList : "+e.toString()+"\n");
			}
			logData.append("["+LogUtils.getCurrentTime()+"]"+" "+"query end getBoardFaqCategoryContentsList ArrayList<BoardFaqVo> al_tbBoardFaqCategoryContentsList : "+al_tbBoardFaqCategoryContentsList+"\n");
	...
	public @ResponseBody HashMap<String, Object> setBoardAjax(HttpServletRequest request, Model model) {
		...
		try {
			...
			logData.append("["+LogUtils.getCurrentTime()+"]"+" "+"query start insertBoardQna BoardCustomQnaVo boardCustomQnaVo : "+boardCustomQnaVo+"\n");
	 ...
	 * @return
	 */
	@RequestMapping(value = "/board/getFaqBoardCategoryContentsListAjax", method = { RequestMethod.POST, RequestMethod.GET })
