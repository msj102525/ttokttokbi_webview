...
<%
	...
	java.text.SimpleDateFormat sp5 = new java.text.SimpleDateFormat("yyyyMMddHHmmss");
%>
...
<%-- <link rel="stylesheet" type="text/css" href="<%=path%>/css/self<c:out value="${call_css_name }" />.css" /> --%>
...
<script type="text/javascript">
	...
	function on_web() {
		...
		var url = "<%=Config.INI_HOST_MOBILETX%>/smart/" + paymethod + "/";
		var params = $("#form1").serialize();
		window.web.payMoveWebView(url, params);
	}
...
<script type="text/javascript">
	...
	function selectPay() {
		...
		if(app_store_type=="1") {
			if(pCode=="P0008"||pCode=="P0035") {
			//if(pCode=="P0008"||pCode=="P0035"||pCode=="P0044") {
				window.web.callPayTicket("custom_contents_repurchase_ticket", pCode);
...
<body>
	...
	<div class="wrap">
		<div class="box1">
			...
			<div class="box_pay">
				<div class="box5">
					<div class="title">
						<p class="left_title">맞춤형 컨텐츠 제작 재구매</p>
					</div>
				</div>
				<div class="pay_div2"><p class="price">33,000원</p><span style="font-size: 14px;">(VAT 포함)</span></div>
				<div class="btn_wrap right_tilte pdr15"><a class="btn7" href="javascript:void(0);" onclick="selectPay('맞춤형 컨텐츠 제작(재구매)','33000','P0035');">구매</a></div>
	...
	<div class="btn_wrap">
		<a class="btn2" href="javascript:void(0);" onclick="window.web.moveToMakePersonalRequest('Y','','P0035');">맞춤형 컨텐츠 제작 요청</a>       
	</div>
	</c:if>
</body>
</html>