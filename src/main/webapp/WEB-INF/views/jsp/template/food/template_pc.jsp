...
<link href="<%=path%>/css/template_pc_style.css" rel="stylesheet" />
<style type="text/css">
/*reset*/
* {
	margin: 0;
...
<body>
	<div id="edmWrap">
		<div class="main">
			...
			<img src="<%=path%>/images/con3.jpg" alt="" border="0"
				usemap="imgmap201765144442">
			<form>
				<div class="territory01">
					<input type="text" class="input-text" id="t01" name="text_type"
						placeholder="PC 텍스트를 입력해주세요" onkeyup="setVailableLength(this, [25, 6], [20, 10], [14, 15])" />
				</div>
