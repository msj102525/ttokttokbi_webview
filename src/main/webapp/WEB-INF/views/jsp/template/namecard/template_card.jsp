...
<link href="<%=path%>/css/template_card_style.css" rel="stylesheet" />
<style type="text/css">
/*reset*/
* {
	margin: 0;
...
<body>
	<div id="edmWrap">
		<div class="main">
			...
			<img src="<%=path%>/images/con2.jpg" alt="" border="0"
				usemap="imgmap201765144442">

			<div class="territory01">
				<input type="text" class="input-text" id="t01" name="text_type"
					placeholder="텍스트를 입력해주세요" onkeyup="setVailableLength(this, [12, 15], [10, 18])" />
			</div>

			<div class="photo" id="img_div_1">
				<img id="i01" onclick="callAndPicture(id)" /> <input type="hidden"
					id="i01_cap" name="image_type" />
			</div>
