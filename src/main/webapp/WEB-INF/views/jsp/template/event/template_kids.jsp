...
<link href="<%=path%>/css/template_kids_style.css" rel="stylesheet" />
<style type="text/css">
/*reset*/
* {
	margin: 0;
...
<body>
	<div id="edmWrap">
		<div class="main">
			...
			<img src="<%=path%>/images/con5.jpg" alt="" border="0"
				usemap="imgmap201765144442">
			<form>
				<div class="territory01">
					<input type="text" class="input-text" id="t01" name="text_type"
						placeholder="텍스트를 입력해주세요" onkeyup="setVailableLength(this, [15, 13], [10, 18])" />
				</div>

				<div class="territory02">
					<input type="text" class="input-text" id="t01" name="text_type"
						placeholder="텍스트를 입력해주세요" onkeyup="setVailableLength(this, [23, 6], [20, 10], [14, 14])" />
				</div>

				<div class="territory03">
					<input type="text" class="input-text" id="t01" name="text_type"
						placeholder="텍스트를 입력해주세요" onkeyup="setVailableLength(this, [15, 12], [10, 18])" />
				</div>
